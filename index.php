...
$f3->route('POST /submitEditpage', 'App\\controllers\\Editpage->submitNewDataSimpleUser');
$f3->route('POST /submitEditpage', 'App\\controllers\\Editpage->submitNewDataAdminUser');
//routes with params
